...
const INTEGRATIONS = [
  { name: "Google Analytics 4", key: "GA4", scope: "Per-client" },
  { name: "Google Search Console", key: "GSC", scope: "Per-client" },
  { name: "Ahrefs", key: "AHREFS", scope: "Per-client" },
  { name: "Rankscale", key: "RANKSCALE", scope: "Per-client" },
  { name: "SEMrush", key: "SEMRUSH", scope: "Per-client" },
] as const;
    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-6 max-w-3xl">
          ...
          <CardContent className="pt-5 space-y-4">
            <div className="grid gap-3 text-sm">
              <div className="grid grid-cols-[140px_1fr] items-center gap-2">
                <span className="text-muted-foreground font-medium">Portal Name</span>
                <span className="font-medium">{themeConfig.brand.name}</span>
              </div>
              <div className="grid grid-cols-[140px_1fr] items-center gap-2">
                <span className="text-muted-foreground font-medium">Short Name</span>
            ...
            <div className="rounded-lg border border-border bg-muted/40 px-4 py-3 text-sm text-muted-foreground">
              ...
              and provide brand assets. Branding assets will be applied here once available.
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="pt-5 space-y-4">
            <div className="rounded-lg border border-border bg-muted/40 px-4 py-3 text-sm text-muted-foreground">
              Data syncs are triggered manually per client. Scheduled sync coming soon.
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Download a JSON export of all clients and portal users. No
                  API credentials or secrets are included.
                </p>
              </div>
              <a
