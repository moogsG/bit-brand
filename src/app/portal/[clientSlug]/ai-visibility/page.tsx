...
export default async function AiVisibilityPage({
	...
	const previous =
		aiVisRows.length > 1 ? aiVisRows[aiVisRows.length - 2] : null;
				...
				<Card>
					<CardContent className="flex flex-col items-center justify-center py-16 space-y-3">
						...
						<p className="text-sm text-muted-foreground text-center max-w-sm">
							AI visibility tracking will appear here once data is synced from
							Rankscale and DataForSEO.
						</p>
					</CardContent>
				</Card>
			) : (
				<>
					...
					<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
						...
						<Card>
							<CardContent className="py-6 flex flex-col items-center gap-1">
								<ScoreDisplay
									score={latest?.secondaryScore ?? null}
									label="Secondary AI Score"
								/>
							</CardContent>
						</Card>
