...
export default async function DashboardPage({
  ...
  // ─── Ahrefs: latest record ────────────────────────────────────────────────
  const ahrefsLatest = await db
    .select()
    .from(ahrefsMetrics)
  ...
  const organicChange = pctChange(organicSessionsCurrent, organicSessionsPrevious);
    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KpiCard
          ...
          value={
            noGa4
              ? "—"
              : organicSessionsCurrent.toLocaleString()
          }
        ...
        <KpiCard
          title="Domain Rating"
          value={
            noAhrefs || ahrefsLatest.domainRating === null
              ? "—"
              : Math.round(ahrefsLatest.domainRating).toString()
          }
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <AiVisibilityCard
          ...
          semrushScore={aiVis?.semrushScore ?? null}
