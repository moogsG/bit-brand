...
interface StrategyEditorProps {
	...
	promptResearchRecommendations?: Array<{
		id: string;
		title: string;
				...
				<Card>
					<CardHeader className="pb-2">
						<CardTitle className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">
							Prompt Research Insights (Top 3)
						</CardTitle>
					</CardHeader>
					<CardContent>
						{promptResearchRecommendations.length === 0 ? (
							<p className="text-sm text-muted-foreground">
								No prompt research recommendations available yet.
							</p>
						) : (
